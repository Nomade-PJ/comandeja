...
const DashboardProducts = () => {
  ...
  const handleUpdateBanner = async (data: BannerFormValues) => {
  ...
  return (
    <DashboardLayout>
      <div className="space-y-4 sm:space-y-6">
        <Card>
          <CardHeader>
            <div className="flex items-center justify-between">
              ...
              {activeTab === "anuncios" && (
                <Button onClick={() => setShowNewBannerModal(true)}>
                  <Plus className="w-4 h-4 mr-2" />
                  Novo Anúncio
                </Button>
              )}
              ...
              <TabsContent value="anuncios">
                <div className="space-y-4">
                  ...
                  <p className="text-sm text-gray-500">
                    Gerencie os banners que serão exibidos na página do seu restaurante
                  </p>
        ...
        />
        <AlertDialog open={showDeleteBannerModal} onOpenChange={setShowDeleteBannerModal}>
          <AlertDialogContent>
            <AlertDialogHeader>
